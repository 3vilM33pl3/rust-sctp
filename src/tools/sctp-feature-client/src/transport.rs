...
use std::net::{
    ...
    SctpScheduler, SctpSendInfo, SctpSocket, SctpStream, SctpTransportConfig, SctpTransportPolicy,
    SctpUdpConfig, SocketAddr,
};
...
pub fn transport_config_for_contract(
    contract: &ScenarioContract,
) -> io::Result<SctpTransportConfig> {
